...
public class DebuggingPurpose : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        DebugAngle_ARCam.text = (Player.transform.rotation.x * Mathf.Rad2Deg).ToString() + " , "  + (Player.transform.rotation.y * Mathf.Rad2Deg).ToString() + " , " + (Player.transform.rotation.z * Mathf.Rad2Deg).ToString();
